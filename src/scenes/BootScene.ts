...
export default class BootScene extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('bg_sky', '../src/assets/bg_sky.png');
        this.load.image('bg_trees', '../src/assets/bg_trees.png');
        this.load.image('helico_crash', '../src/assets/helico_crash.png');
        this.load.image('jungle_tiles', '../src/assets/jungle_tiles.png');
        this.load.spritesheet('player', '../src/assets/survivor_spritesheet_v2.png', { frameWidth: 170, frameHeight: 204 });
        this.load.spritesheet('bat', '../src/assets/morcego_spritesheet_aligned.png', { frameWidth: 256, frameHeight: 256 });
